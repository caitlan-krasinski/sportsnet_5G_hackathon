...
def player_marking(doc, df, headers, id_def, id_att, slider_steps, x_range, y_range,
    ...
    c = (['dodgerblue'] * len(team_def['player_id'].unique()) + ['green'] * len(team_att['player_id'].unique()) + [
        'gold'])
    """
    ...
    plot = figure(name='base', plot_height=860, plot_width=1889,
    ...
    plot.multi_line('xs', 'ys', source=source_lines, color='green',
